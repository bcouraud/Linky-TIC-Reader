...
//const char* host_url = "tip.unice.fr";
const char* host_url = "imredd.charge.com";
...
Serial.println(host_parameter);
  ...
  String url = "/v1/api/assets/1234567890/consumptions"; //"/a/check";
...
client.stop();
    if (client.connect(host_url_certif, url_port)) {
      ...
      client.println(F("Authorization: Bearer 12356789..U54OuAHPW2GmCDo9aCVFqQoIXNUq00UA9jggR6ixqHo"));
...
/*client.stop();
    if (client.connect(github_host, 443)) {
      ...
      client.println(F("Connection: close"));
      client.println(F("Content-Type: application/json"));
      //client.println(F("Authorization: Bearer 12345678..1C9H2giT6xGbDNAVgeuGPuHphHZD0VbkPrDdA_uNg-8"));
      client.println(F("Authorization: Bearer 1235678..Ui9eNJG6OFNBJboMzF2Wrew6J9Au-hkgSVfLBXnDGQ8"));
      client.print(F("Content-Length: "));
      client.println(httpRequestData.length());
      client.println();
      client.println(httpRequestData);
