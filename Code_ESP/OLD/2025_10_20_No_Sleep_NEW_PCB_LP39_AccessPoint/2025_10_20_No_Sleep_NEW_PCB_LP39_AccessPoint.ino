       ...
       // We are connected to the Linky
                     ...
                     //if (rawADC>0)
                     {
                              //  uint addr = 0; //address of eeprom memory
                                 ...
                                 ssid_Wifi     = "Livebox-CB4A";
                                 password_Wifi = "FZNdu4aWShWEp3NSox";
                                 }
   ...
   Serial.println("Trying to connect to Wifi");
                     ...
                     if (ssid_Wifi != nullptr && strlen(ssid_Wifi) > 0) {
                        ...
                        // Try connecting to user's WiFi
                           ...
                           message += "<p>Vous pouvez desormais debrancher le cable USB et brancher le dongle Linky sur votre compteur, comme indique dans la procedure.</p>";
                           } else {
