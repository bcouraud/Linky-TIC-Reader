...
long int t1 = 0;
long int t2=0;
float voltageThreshold = 6.05; //190; //207; // voltage limit to startup the communication
float voltageThreshold2 = 5.3; //170; // voltage limit to startup the process
int epoch_time = 0;
...
//delay(50);
 ...
 //  pinMode(4, INPUT); // reading Voltage (digital) on D2
...
//Serial.swap();
       ...
       real_voltage = rawADC/1024*3.1*2 ;
