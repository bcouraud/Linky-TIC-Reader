...
float voltageThreshold2 = 5.5; //170; // voltage limit to startup the process
int epoch_time = 0;
       ...
       // We are connected to the Linky
            ...
            digitalWrite(LED_BUILTIN, HIGH); // initialisation
             delay(50);
                     ...
                     real_voltage = 2* rawADC * (3.2f / 1023.0f);  // adjust 3.2 to your board's actual max if you calibrate
                  ...
                  if (real_voltage>voltageThreshold2)
                   ...
                   //  uint addr = 0; //address of eeprom memory
                     ...
                     rawADC = analogRead(A0); // we read voltage
                     real_voltage = 2*rawADC * (3.2f / 1023.0f);  //0.0312*rawADC-0.4873;  //5.24V --> 181  or 5.06V -->174  or 4.90 -->170 or 4.18 --> 147
                              if (debug==1){
                     ...
                     puissanceCommuniquee= 19; //puissance_moyenne/counter_moyenne; 
