...
long int t1 = 0;
long int t2=0;
float voltageThreshold = 6.0; //6.0 is actually 6.25   190; //207; // voltage limit to startup the communication
...
client.stop();
 ...
 Serial.println(httpRequestData);
         ...
         String httpRequestData = "linkySensor,sensor_id=LinkyHouse3 power="+String(puissanceCommuniquee)+",danger="+String(Danger)+",voltage="+String(real_voltage)+",frequency=50.2,pf=0.9 "+String(epoch_time)+"000000000";
