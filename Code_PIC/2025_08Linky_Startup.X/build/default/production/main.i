...
unsigned int limit_ADC = 1;
unsigned int limit_RisingVoltage = 4;
unsigned int minVoltage = 255;
unsigned int maxVoltage = 0;
unsigned int limit_Reset = 15;
unsigned int threshold1 = 240;
unsigned int threshold2 = 190;
